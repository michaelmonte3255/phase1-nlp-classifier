...
Data
Source: real-world URL dataset aggregating OpenPhish, URLhaus, and Tranco — actual phishing URLs and actual legitimate site rankings, not synthetic examples.
...
Metrics:
Model	Precision (phishing)	Recall (phishing)	F1 (phishing)	Accuracy
Logistic Regression (baseline)	0.92	0.90	0.91	0.91
